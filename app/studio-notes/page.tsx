...
const entries = [
  {
    ...
    date: "May 15, 2026",
    paragraphs: [
      "'Held', the first painting in <em>Returning</em>, didn't announce itself as a series. It was simply a space I couldn't stop thinking about. Something about the quality of presence in that image. The way it held both absence and welcome at once.",
